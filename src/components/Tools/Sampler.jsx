...
/**
 * Sampler - A virtual instrument tool for playing piano or drum sounds
...
const Sampler = ({
  ...
  useEffect(() => {
    ...
    // Initialize Tone.Recorder for capturing audio
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e) => {
      ...
      // Check if this is a valid sampler key
