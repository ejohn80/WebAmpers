    ...
    <div className="tracklane-root">
      ...
      <div className="tracklane-main">
        ...
        {segments.map((seg) => {
          ...
          return (
            <div className="tracklane-segment" key={seg.id || seg.fileUrl || Math.random()}>
              <div className="segment-meta">
                <div className="segment-name">{seg.id ?? seg.fileUrl ?? 'segment'}</div>
                <div className="segment-duration">{seg.durationMs ? `${Math.round(seg.durationMs)} ms` : ''}</div>
              </div>
